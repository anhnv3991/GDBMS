...
void Utilities::MarkNonZeros(ulong *input, int size, ulong *output)
{
	int block_x, grid_x;
...
void Utilities::MarkNonZeros(ulong *input, int size, ulong *output, cudaStream_t stream)
{
	int block_x, grid_x;
...
void Utilities::RemoveZeros(ulong *input, ResBound *in_bound, ulong *output, ResBound *out_bound, ulong *output_location, int size)
{
	int block_x, grid_x;
...
void Utilities::RemoveZeros(ulong *input, ResBound *in_bound, ulong *output, ResBound *out_bound, ulong *output_location, int size, cudaStream_t stream)
{
	int block_x, grid_x;
...
void Utilities::MarkTmpLocation(ulong *tmp_location, ulong *input, int size)
{
	int block_x, grid_x;
...
void Utilities::MarkTmpLocation(ulong *tmp_location, ulong *input, int size, cudaStream_t stream)
{
	int block_x, grid_x;
...
void Utilities::MarkLocation(ulong *location, ulong *input, int size)
{
	int block_x, grid_x;
...
void Utilities::MarkLocation(ulong *location, ulong *input, int size, cudaStream_t stream)
{
	int block_x, grid_x;
...
void Utilities::ComputeOffset(ulong *input1, ulong *input2, ulong *out, int size)
{
	int block_x, grid_x;
...
void Utilities::ComputeOffset(ulong *input1, ulong *input2, ulong *out, int size, cudaStream_t stream)
{
	int block_x, grid_x;
...
template <typename T>
void Utilities::ExclusiveScan(T *input, int ele_num, T *sum)
{
...
template <typename T>
void Utilities::ExclusiveScan(T *input, int ele_num)
{
	thrust::device_ptr<T> dev_ptr(input);
...
template <typename T>
void Utilities::ExclusiveScan(T *input, int ele_num, cudaStream_t stream)
{
	thrust::device_ptr<T> dev_ptr(input);
...
template <typename T>
void Utilities::InclusiveScan(T *input, int ele_num)
{
	thrust::device_ptr<T> dev_ptr(input);
...
template <typename T>
void Utilities::InclusiveScan(T *input, int ele_num, cudaStream_t stream)
{
	thrust::device_ptr<T> dev_ptr(input);
...
unsigned long Utilities::timeDiff(struct timeval start, struct timeval end)
{
...
void Utilities::RemoveEmptyResult(RESULT *out_bound, RESULT *in_bound, ulong *in_location, ulong *out_location, uint in_size)
{
	int block_x, grid_x;
...
void Utilities::RemoveEmptyResult(RESULT *out_bound, RESULT *in_bound, ulong *in_location, ulong *out_location, uint in_size, cudaStream_t stream)
{
	int block_x, grid_x;
...
void Utilities::RemoveEmptyResult(RESULT *out, RESULT *in, ulong *location, int size)
{
	int block_x, grid_x;
...
void Utilities::RemoveEmptyResult(RESULT *out, RESULT *in, ulong *location, int size, cudaStream_t stream)
{
	int block_x, grid_x;
